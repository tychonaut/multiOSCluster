...
#this is the actual command; uncomment when all is working again
...
#mpiexec.exe -np 4 -machinefile D:\apps\ParaView\v5.8.0_CAVE\bin\machines_noRt4.txt  D:\apps\ParaView\v5.8.0_CAVE\bin\pvserver.exe  D:\apps\ParaView\v5.8.0_CAVE\bin\dome_arena.pvx
